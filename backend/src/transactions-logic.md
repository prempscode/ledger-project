...
- **Status Update:** Only _after_ both the debit and credit ledger entries are successfully created is the transaction status updated from **Pending** to **Completed**.
